...
//////////////////////////////////////////////////////////////////////////////////////// SAVING	    
    ...
    wlTb.addButton("tRet",4,"Torna a Lista Detenuti","User group.ico","");
    ...
    histTb.addButton("tRet",2,"Torna a List Detenuti","User group.ico","");
	...
	function wlEdit(_dettId,wlId) {
	    ...
	    dpw.attachEvent("onAfterUpdate",function(sid,action,tid,xml_node){
	        ...
	        if(action=="inserted"){
				...
				wlGrid.cells(sid,4).setValue(wlForm.getItemValue("callsQta") + " entro " +  getOptionText(wlForm,"attWithin"));
